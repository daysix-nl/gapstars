        ...
        <div class="content w-5/12 border-r-2 pl-5 border-lichtgrijs">
            <?php if( have_rows('about_us_repeater', 'option') ): ?>
                <?php while( have_rows('about_us_repeater', 'option') ): the_row(); ?>
                    <a href="<?php echo the_sub_field('url', 'option'); ?>">
                        <p class="text-28 leading-38 text-wit font-light font-dmsans"><?php echo the_sub_field('name', 'option'); ?></p>
                    </a>
                <?php endwhile; ?>
            <?php endif; ?>
        </div>
        <div class="content w-8/12 text-wit pl-5 flex gap-3 pb-3">
            <?php if( have_rows('hubs_repeater', 'option') ): ?>
                <?php while( have_rows('hubs_repeater', 'option') ): the_row(); ?>
                    <div class="blok1">
                        <a class="h-[175px] w-[160px] rounded-3xl relative overflow-hidden block scale-img" href="<?php echo the_sub_field('url', 'option'); ?>">
                            <img class="w-full object-cover h-[175px]  ease-in-out duration-500" src="<?php echo the_sub_field('image', 'option'); ?>" alt="">
                            <div class="inner-hub"><p class="text-20 leading-19 text-wit font-normal font-dmsans"><?php echo the_sub_field('title', 'option'); ?></p></div>
                        </a>
                    </div>
                <?php endwhile; ?>
            <?php endif; ?>
