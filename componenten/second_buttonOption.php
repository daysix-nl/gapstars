...
?>
     <a 
        ...
        class="btn-<?php echo the_field('second_button_color', 'option');?> text-16 leading-16 md:text-16 md:leading-26  font-dmsans font-light p-button rounded-full transition ease-in duration-300 hover:ease-out h-[45px] flex items-center w-fit"> 
