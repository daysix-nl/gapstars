<section class=" <?php echo get_field('background-color'); ?> <?php echo get_field('inner-padding'); ?> <?php  echo (get_field('element_bottom')) ? "mb-[-60px]" : echo get_field('inner-margin'); ?> ">
