...
?>
    ...
    <section class="my-10 md:my-12 <?php echo the_field('background-color'); ?> <?php echo the_field('inner-padding'); ?>">

        <div class="container mb-6 ">
            <?php if(get_field('title')): ?>
                <h2 class="<?php echo the_field('text-color') ?>  text-50 leading-50 lg:text-65 lg:leading-65 font-medium mb-5"><?php echo the_field('title');?></h2>
            <?php endif; ?>
        ...
        <?php if( get_field('cards_navigation') ): ?>
            <?php if( have_rows('card') ): ?>
                <div class="container grid md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 mmt-[-50px] mb-10  md:mt-[-60px] md:mb-12">
                    ...
                    ?>
                        <a class="button-gray <?php echo the_field('text-color_custom_navigation'); ?> rounded-3xl h-10 col-span-1 text-16 leading-26 p-3 flex items-center <?php echo the_field('background-color_custom_navigation'); ?> hover:<?php echo the_field('text-color_custom_navigation_hover'); ?> hover:<?php echo the_field('background-color_custom_navigation_hover'); ?>" href="#<?php echo $titlenospaces ?>"><img class="w-[44px] mr-3" src="/wp-content/themes/gapstars/img/icons-acf/<?php echo the_sub_field('icon'); ?>.svg" alt="<?php echo the_sub_field('title'); ?>"> <p><?php echo the_sub_field('title'); ?></p></a>
                    <?php endwhile; ?>
        ...
        <?php if( have_rows('card') ): ?>
            ...
            <?php while( have_rows('card') ): the_row(); ?>
                <div 
                    <?php if(get_field('column') == 'grid-cols-3'): ?>
                        class="col-span-1 <?php echo the_field('background-color_inner'); ?>  rounded-3xl h-auto"
                    <?php elseif(get_field('column') == 'grid-cols-2'): ?> 
                        class="col-span-1 <?php echo the_field('background-color_inner'); ?>  rounded-3xl h-auto"
                    <?php elseif(get_field('column') == 'grid-cols-1'): ?> 
                        class="col-span-1 <?php echo the_field('background-color_inner'); ?>  rounded-3xl h-auto flex-col md:flex-row flex <?php  echo (get_field('gap')) ? "" : "gap-3 md:gap-5"; ?>"
                    <?php endif; ?>
                ...
                >
                    <div
                        <?php if(get_field('column') == 'grid-cols-3'): ?>
                            class="<?php echo the_field('image_height'); ?> w-full overflow-hidden flex items-center justify-center scale-img"
                        <?php elseif(get_field('column') == 'grid-cols-2'): ?> 
                            class="<?php echo the_field('image_height'); ?> w-full overflow-hidden flex items-center justify-center scale-img "
                        <?php elseif(get_field('column') == 'grid-cols-1'): ?> 
                    ...
                    <div 
                        <?php if(get_field('column') == 'grid-cols-3'): ?>
                            class="flex flex-col <?php echo the_field('padding_inner_card'); ?> <?php  echo (get_field('vertical-align')) ? "justify-top" : "justify-center"; ?> gap-3"
                        <?php elseif(get_field('column') == 'grid-cols-2'): ?> 
                            class="flex flex-col <?php echo the_field('padding_inner_card'); ?> <?php echo (get_field('vertical-align')) ? "justify-top" : "justify-center"; ?> gap-3"
                        <?php elseif(get_field('column') == 'grid-cols-1'): ?> 
                    ...
                    >
                        <h3 
                            <?php if(get_field('column') == 'grid-cols-3'): ?>
                                class="<?php echo the_field('text-color_inner'); ?> font-medium text-26 leading-28  "
                            <?php elseif(get_field('column') == 'grid-cols-2'): ?> 
                                class="<?php echo the_field('text-color_inner'); ?> font-medium text-26 leading-28  "
                            <?php elseif(get_field('column') == 'grid-cols-1'): ?> 
                                class="<?php echo the_field('text-color_inner'); ?> font-medium text-38 leading-38  "
                            <?php endif; ?>
                        ><?php echo do_shortcode(the_sub_field('title')); ?></h3>

                        <?php if(get_sub_field('text')): ?>
                            <p class="<?php echo the_field('text-color_inner'); ?> text-16 leading-26"><?php echo the_sub_field('text'); ?></p>
                        <?php endif; ?>
                        
                        <?php if( have_rows('list') ): ?>
                            <ul class="list-disc ml-[12px] flex flex-col gap-1">
                            <?php while( have_rows('list') ): the_row(); ?>
                                <li class="<?php echo the_field('text-color_inner'); ?>">
