    ...
    <?php if ($post->have_posts()): ?>
        <div class="container grid gap-2 md:gap-3 md:grid-cols-3">
                ...
                <a class="col-span-1 bg-white rounded-3xl h-auto grid" href="<?php the_permalink(); ?>">
                    <img class=" h-[200px] w-full object-cover overflow-hidden rounded-t-3xl" src="<?php echo the_field('image_post_client', $post_id); ?>" alt="">
                    <div class="bg-black w-[120px] h-[120px] flex justify-center items-center rounded-full p-1.5 mx-auto mt-[-75px]">
                        <img src="<?php echo the_field('logo_post_client', $post_id); ?>" alt="">
                    </div>
                    <div class="pb-4 pt-2  mx-3">
                        ...
                        <p class="text-black text-16 leading-26"><?php echo the_field('text_post_client', $post_id); ?></p>
