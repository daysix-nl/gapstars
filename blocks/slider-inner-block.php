...
?>
    <section class="<?php echo the_field('inner-margin'); ?> <?php echo the_field('background-color'); ?> <?php echo the_field('inner-padding'); ?> relative">
        <div class="container">
            <div class="<?php echo the_field('background-color_inner'); ?> rounded-3xl p-3 sm:p-6">
                    ...
                    <?php while( have_rows('slider_repeater') ): the_row(); ?>
                            <div class="swiper-slide flex gap-3 flex-col sm:flex-row ">
                                <div class="w-full sm:w-1/2">
                                    <img class="max-h-[275px] mx-auto" src="<?php echo the_sub_field('image'); ?>" alt="<?php echo the_sub_field('image_alt'); ?>">
                                </div>
                                <div class="w-full sm:w-1/2 text-center sm:text-start">
                                    <h3 class="text-26 leading-28 sm:text-40 sm:leading-40 pb-3 font-bold <?php echo the_field('text-color_inner'); ?>"><?php echo the_sub_field('title'); ?></h3>
                                    <p class="text-16 leading-26 <?php echo the_field('text-color_inner'); ?>"><?php echo the_sub_field('text'); ?></p>
                                </div>
                            </div>
                    <?php endwhile; ?>
                        </div>
