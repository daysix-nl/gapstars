                    ...
                    <?php while( have_rows('slider_repeater') ): the_row(); ?>
                            <div class="swiper-slide flex gap-3 flex-col sm:flex-row ">
                                ...
                                <div class="w-full sm:w-1/2 text-center sm:text-start">
                                    <h3 class="text-26 leading-28 sm:text-40 sm:leading-40 pb-3 font-bold <?php echo get_field('text-color_inner'); ?>"><?php echo the_sub_field('title'); ?></h3>
                                    <p class="text-16 leading-26 <?php echo get_field('text-color_inner'); ?>"><?php echo the_sub_field('text'); ?></p>
                                </div>
                            </div>
                    <?php endwhile; ?>
                        </div>
