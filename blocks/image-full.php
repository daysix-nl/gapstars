        ...
        <div class="container image-full-container">
            <div class="relative">
                <?php if(get_field('overlay')): ?>
                    <div class=" img-overlay <?php echo the_field('background-color_inner'); ?> rounded-3xl z-[1] opacity-40"></div>
                <?php endif; ?>
                <img
                    <?php if( $height == 'low' ): ?>
                ...
                <div class="absolute top-1/2 left-1/2 text-center center-text-transform w-full md:w-4/5 p-1 md:p-6 z-[2]">
                    <?php if(get_field('title')): ?>
                        <h3 class="text-26 leading-36 md:text-40 md:leading-40 <?php echo the_field('text-color_inner'); ?> font-medium "><?php echo the_field('title');?></h3>
                    <?php endif; ?>
