        ...
        <div class="container grid md:grid-cols-5 gap-5 md:gap-10">
            ...
            <?php if(get_field('title')): ?>
                <div class="md:col-span-2">
                    <div class="mb-3 rounded-3xl p-4 <?php echo the_field('background-color_inner'); ?> h-auto grid gap-3 ">
                        <h3 class="text-30 md:text-40 leading-30 md:leading-40 <?php echo the_field('text-color_inner'); ?> font-medium md:pr-10 max-w-[350px]"><?php echo the_field('title'); ?></h3>
                        ...
                        <p class="<?php echo the_field('text-color_inner'); ?> text-16 leading-26 md:mr-10 max-w-[350px]">
