                    ...
                    if( have_rows('card_repeater') ):
                        while( have_rows('card_repeater') ) : the_row(); ?>
                            <div class="md:col-span-1 text-center md:border-r-2 md:border-<?php echo get_field('border-color'); ?> md:last-of-type:border-r-0 px-4 pt-6 md:py-0 whoweare-card">
                                <img class="mx-auto" src="/wp-content/themes/gapstars/img/icons-acf/<?php echo get_sub_field('card_repeater_icon');?>.svg" alt="">
                                <h3 class="text-26 leading-28 mt-4 mb-3 md:my-4 <?php echo get_field('text-color_inner'); ?>"><?php echo get_sub_field('card_repeater_title');?></h3>
                                <p class="text-16 leading-24 md:text-16 md:leading-26 w-full sm:w-4/5 md:w-full mx-auto <?php echo get_field('text-color_inner'); ?>"><?php echo get_sub_field('card_repeater_text');?></p>
