...
?>
    ...
    <section class="<?php the_field('inner-margin'); ?> <?php the_field('background-color'); ?> <?php the_field('inner-padding'); ?> overflow-hidden">
        <div class="container mb-6 ">
            <?php if(get_field('title')): ?>
                <h2 class="<?php the_field('text-color') ?>  text-50 leading-50 md:text-65 md:leading-70 font-medium  mx-auto <?php the_field('align_title'); ?> mb-5"><?php the_field('title');?></h2>
            <?php endif; ?>
            <?php if(get_field('subtitle')): ?>
                <h3 class="text-22 md:text-26 leading-30 md:leading-36 <?php the_field('text-color'); ?> <?php the_field('align_title'); ?>"><?php the_field('subtitle'); ?></h3>
            <?php endif; ?>
        </div>
