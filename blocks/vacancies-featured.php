...
?>
  <section class="<?php the_field('inner-margin'); ?> <?php the_field('background-color'); ?> <?php the_field('inner-padding'); ?> vacancies-featured">
      <?php if(get_field('title')): ?>
          <div class="container text-center">
              <h2 class="text-40 leading-40 md:text-65 md:leading-70 pb-6 font-medium <?php the_field('text-color') ?>"><?php the_field('title'); ?></h2>
          </div>
      <?php endif; ?>
          <div class="container">
