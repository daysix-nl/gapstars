    ...
    <section id="home-header" class="bg-[#202020] pb-4">
            <div class="container text-wit home-header-section grid grid-cols-3 items-center">
                <div class="col-span-3 lg:col-span-2">
                    ...
                    <p class="text-22 leading-30 md:text-26 md:leading-36 font-light lg:w-[80%] pr-4 mt-3"><?php echo the_field('text', 'option') ?></p>
                ...
                <div class="col-span-1 hidden lg:flex relative">
                    <img class="w-full border-animation absolute bottom-[-20px] top-2 left-40 right-[-20px] z-[1]"src="<?php echo the_field('image_border'); ?>" alt="">
                    <div class="p-0 z-[2]">
                        <img class="w-full rounded-3xl " src="<?php echo the_field('image'); ?>" alt="">
                    </div>
                </div>
            </div>
