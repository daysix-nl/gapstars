                    ...
                    $post_id = get_the_ID(); ?>
                        <div class="container grid grid-cols-1 md:grid-cols-2 gap-[25px] md:gap-6">
                            ...
                            <div class="col-span-1 md:py-4">
                                ...
                                <p class="w-full md:max-w-[400px] text-diepgrijs text-18 leading-28 lg:text-24 lg:leading-34 font-dmsans pt-2 line-clamp-4"><?php echo the_field('teaser-text', $post_id);?></p>
                                <p class="font-medium text-18 leading-26 text-oranje pt-2"><?php echo the_field('day', $post_id);?>, <?php echo the_field('day_number', $post_id);?> <?php echo the_field('month', $post_id);?> <?php echo the_field('year', $post_id);?></p>
                                <div class="flex pt-2 gap-2 md:gap-3 flex-wrap">
                                    ...
                                    <a class="bg-[#FFFFFF] text-16 leading-16 md:text-16 md:leading-26  font-dmsans font-light p-button rounded-full transition ease-in duration-300 hover:ease-out h-[45px] flex items-center w-fit"
                                        ...
                                        <?php echo the_field('call_to_action_button', $post_id);?>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                while ($query->have_posts()) {
                    ...
                    <div class="overflow-hidden  grid-cols-1 md:grid-cols-3 md:gap-3 bg-lightcreme rounded-3xl box-events grid">
                        ...
                        <div class="col-span-1 md:col-span-2 pt-2 pb-6 md:py-3 px-3 md:px-0">
                            ...
                            <p class="mb-2 md:max-w-[340px] text-18 leading-28 text-diepgrijs line-clamp-3"><?php echo the_field('teaser-text', $post_id);?></p>
                            <p class="text-14 leading-26 text-oranje font-medium"><?php echo the_field('day', $post_id);?>, <?php echo the_field('day_number', $post_id);?> <?php echo the_field('month', $post_id);?> <?php echo the_field('year', $post_id);?></p>
                            <div class="flex pt-2 gap-2 md:gap-3 flex-wrap">
